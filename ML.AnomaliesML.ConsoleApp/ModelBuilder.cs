...
using ML_AnomaliesML.Model;

namespace ML_AnomaliesML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\karunakaran\Downloads\sentiment.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\karunakaran\AppData\Local\Temp\MLVSTools\ML.AnomaliesML\ML.AnomaliesML.Model\MLModel.zip";
